...
def train_maskrcnn():
    ...
    if not config.only_create_dataset:
        ...
        loss_monitor = ms.LossMonitor(20)
        cb = [time_cb, loss_cb]
        ...
        model.train(config.epoch_size, dataset, callbacks=[loss_monitor], dataset_sink_mode=dataset_sink_mode_flag)
